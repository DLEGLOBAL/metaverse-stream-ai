...
import { Settings as SettingsIcon, User, Shield, Monitor, Headphones, Camera, Database, Key, Save, Cpu, Globe, Palette } from 'lucide-react';
    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          ...
          {activeTab !== 'general' && activeTab !== 'account' && activeTab !== 'layout' && (
            <Card className="glass-card">
              <CardHeader className="pb-2">
